\chapter*{VITA}
	...
	\vitaentry{Oct, 2014}{Submitted a paper summarizing the design and control of the BlueFoot platform to the 2015 International Conference on Robotics and Automation (ICRA).}
	\vitaentry{Mar, 2015}{Submitted a paper on a NARX Neural Network trunk leveling controller for legged robots to the 2015 International Conference on Intelligent Robots and Systems (IROS).}
