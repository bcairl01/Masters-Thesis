...
%
	...
	\section{Dynamical Model}
		...
		\subsection{System State Vector and Dynamics}
			...
			The dynamical model of the BlueFoot platform derived by considering a free-floating body with four ridged legs, each of which have four degrees of freedom. This system is fully described by the state vector $z \equiv [\eta^{T}, \dot{\eta}^{T}]^{T} \RRealVec{44}$ and its dynamics are:
				\begin{equation}
