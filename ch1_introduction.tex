...
\chapter{Introduction}
	...
	\section{Trunk stabilization}
		...
		\begin{figure}[h!]
			\centering
			\fbox{\includegraphics[width=0.8\textwidth]{narx_network_diagram.png}}
